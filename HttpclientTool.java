package com.meiya.hx.caseplatform.common.util;
...
public class HttpclientTool {
    ...
    public static List<String> doGetZipString(String url,Map<String,String> hadparam) throws Exception {
        // 获取压缩文件输入流
        HttpClient httpClient = HttpClients.createDefault();
        HttpGet httpGet = new HttpGet(url);
        packageHeader(hadparam,httpGet);
        ...
        while ((entry = zIn.getNextEntry()) != null) {
            ...
            if (!entry.isDirectory()) {
                ...
                while ((zIn.read(buf)) != -1) {
                    sb.append(Arrays.toString(buf).trim());
                }
